...
public class MapGenerator : MonoBehaviour
{
    ...
    public void DrawMapInEditor()
    {
        ...
        MapDysplayer display = FindFirstObjectByType<MapDysplayer> ();
    ...
    {
        float[,] noiseMap = Noise.GenerateNoiseMap(mapChunkSize, mapChunkSize, noiseScale, octaves, persistance, lacumarity, seed, centre + offset, normalizedMode);
